...
function buildMail(
  ...
  const core = `Damit die Übergabe entspannt klappt, wäre die Restzahlung von ${betragFmt} EUR vorab gut. Alternativ können Sie auch bar bei der Übergabe zahlen — kurze WhatsApp reicht, dann nehme ich es so auf.`;
