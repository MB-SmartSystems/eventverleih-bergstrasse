...
import { buildRestzahlungInfo } from "@/lib/eventverleih/mail-templates/build/restzahlung-info";
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    for (const b of all.results) {
      ...
      const mail = buildRestzahlungInfo({
        kundeName,
        restSoll,
        eventDatumVon: b.Event_datum_von,
        stripeLink: b.Stripe_Restzahlung_Link,
        meinBereichUrl,
      });
